...
<style>
body{
background-image:url(https://i.pinimg.com/564x/c3/cd/65/c3cd6569d5e7dc30c2e64fc6ef24074d.jpg);
}
h3,h4,h5,h6,p{
                ...
                <div class="col-md-6 mx-auto shadow rounded p-0">
                    <div class="card card-profile mb-0">
                        ...
                        <div class="team-content">
                            ...
                            <h5 class="changesToJustify"><?=isset($card['description'])?htmlspecialchars($card['description']):''?></h5>
                        </div>
